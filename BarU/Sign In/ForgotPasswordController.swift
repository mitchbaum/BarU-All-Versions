...
class ForgotPasswordController: UIViewController {
    ...
    private func setupUI() {
        ...
        sendButton.leftAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leftAnchor, constant: 64).isActive = true
        sendButton.rightAnchor.constraint(equalTo: view.safeAreaLayoutGuide.rightAnchor, constant: -64).isActive = true
