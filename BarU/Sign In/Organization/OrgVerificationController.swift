//
//  OrgVerificationController.swift
//  BarU
//
//  Created by Mitch Baumgartner on 7/26/21.
//
...
protocol OrgVerificationControllerDelegate {
    func buildOrg()
}

class OrgVerificationController: UIViewController {
    ...
    var delegate: OrgVerificationControllerDelegate?
    ...
    let instructionsLabel: UILabel = {
        let label = UILabel()
        label.text = "My 6 digit verification code provided by the BarU team during onboarding is"
...
extension OrgVerificationController : UITextFieldDelegate {
