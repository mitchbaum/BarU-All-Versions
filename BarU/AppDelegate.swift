...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        if #available(iOS 13.0, *) {
            ...
            UINavigationBar.appearance().tintColor = .white
            appearance.backgroundColor = UIColor.matteBlack
            // makes large navigation bar title color white
            appearance.largeTitleTextAttributes = [.foregroundColor : UIColor.white, NSAttributedString.Key.font: UIFont(name: "Rokkitt-Bold", size: 30) ??
                                                    UIFont.systemFont(ofSize: 36)] //portrait title
        ...
        // once app launches run this command which sets up the database
